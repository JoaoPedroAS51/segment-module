...
export default class Client {
  ...
  async identify (userId = null, traits = {}, options = {}) {
    ...
    await this._validateUserId('Identify', anonymousId, userId)
  ...
  async track (event = null, properties = {}, options = {}) {
    ...
    await this._validateUserId('Track', anonymousId, userId)
  ...
  async page (param1 = null, param2 = null, param3 = {}, param4 = {}) {
    ...
    await this._validateUserId('Page', anonymousId, userId)
  ...
  async group (groupId = null, traits = {}, options = {}) {
    ...
    await this._validateUserId('Group', anonymousId, userId)
  ...
  async alias (userId = null, previousId = null, options = {}) {
    ...
    await this._validateUserId('Alias', previousId, userId)
